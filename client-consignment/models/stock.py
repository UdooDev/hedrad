...
class StockMoves(models.Model):
    ...
    def _action_assign(self):
        ...
        # _logger.info("==============assign=====first============")
        for move in self.filtered(lambda m: m.state in ['confirmed', 'waiting', 'partially_available']):
            _logger.info("==============last partially_available_moves=================%s", partially_available_moves)
        _logger.info("==============assign==here===============%s", partially_available_moves)
        # partially_available_moves.write({'state': 'partially_available'})
        _logger.info("============== assign==partially_available_moves===============%s", partially_available_moves)
        # assigned_moves.write({'state': 'assigned'})
        _logger.info("==============last assign=================")
